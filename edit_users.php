    ...
    foreach ($cursor as $document) 
      {
        ...
        if(!empty($document["user_level"] )){$user_level = $document["user_level"] ;}
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
                      ...
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Update Details</h4>
                          <form class="form-horizontal tasi-form" action="edit_users_process.php" method="post">
                                   <div class="form-group ">
                                  <label class="col-sm-2 col-sm-2 control-label" >ID</label>
                                  <div class="col-lg-10">
                                      <input type="label" class="form-control" id="id" name="id" value="<?php echo $_GET["id"]; ?>" disabled>
                                      <input type="hidden" class="form-control" id="id1" name="id1" value="<?php echo $_GET["id"]; ?>" >
                                  </div>
                              </div>
                              <div class="form-group ">
                              ...
                              <div class="form-group ">
                                  ...
                                  <div class="col-lg-10">
                                      <input type="text" class="form-control" id="user_level" name="user_level" value="<?php print_r($user_level) ; ?>">
                                  </div>
                              </div>
