                            ...
                            $i=0;
                              ...
                              <td>
                                  <?php
                                   ...
                                   print "Total correct for Malaysia : " . $cursor_count3a . " | ";

                                  if (!empty($document['user_level'])){echo "User Level : ". $document['user_level'];}
                                  ?>
                              </td>
                              <td>
                                      <a href="<?php echo "edit_users.php?id=".$document['_id'] ;?>" class="btn btn-warning btn-xs "><i class="fa fa-compass"> Edit</i></a>
                                      <a href="<?php echo "delete_users_process.php?id=".$document['_id'] ;?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o "> Delete</i></a>
                                  </td>
                              </tr>
                            <?php } ?>
